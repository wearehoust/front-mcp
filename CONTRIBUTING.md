...
- **Bugs:** Use the [bug report template](https://github.com/wearehoust/front-mcp/issues/new?template=bug_report.md)
- **Features:** Use the [feature request template](https://github.com/wearehoust/front-mcp/issues/new?template=feature_request.md)
